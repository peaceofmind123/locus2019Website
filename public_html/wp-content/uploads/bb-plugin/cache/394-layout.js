...
var wpAjaxUrl='http://test.geetamata.edu.np/wp-admin/admin-ajax.php';var flBuilderUrl='http://test.geetamata.edu.np/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://test.geetamata.edu.np/wp-content/plugins/bb-plugin/',wpAjaxUrl:'http://test.geetamata.edu.np/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
$(this.nodeClass+' .fl-send-error').fadeIn();return false;}}};})(jQuery);(function($){$(function(){new FLBuilderContactForm({id:'5a413e9a267a2'});});})(jQuery);